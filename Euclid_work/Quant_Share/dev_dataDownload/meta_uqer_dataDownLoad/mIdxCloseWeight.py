...
def mIdxCloseWeight(begin, end, **kwargs):
    ...
    data = DataAPI.mIdxCloseWeightGet(ticker=kwargs['ticker'], secID="", beginDate=begin, endDate=end, beginYear=u"", endYear=u"", reportType=u"",
...
def mIdxCloseWeight_update(upDateBegin, endDate=None):
    ...
    rolling_save(mIdxCloseWeight, 'mIdxCloseWeight', upDateBegin, endDate, freq='Y', subPath="{}/mIdxCloseWeight".format(dataBase_root_path),
                 reWrite=True, monthlyStack=False, ticker=['000300', '000905', '000852'])